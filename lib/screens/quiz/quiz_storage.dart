...
class QuizRAMScreen extends StatefulWidget {
  const QuizRAMScreen({Key? key}) : super(key: key);

  @override
  QuizRAMScreenState createState() => QuizRAMScreenState();
}

class QuizRAMScreenState extends State<QuizRAMScreen> {
  var db = DBconnect();
