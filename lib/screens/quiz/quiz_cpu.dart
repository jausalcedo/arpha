...
class QuizCPUScreen extends StatefulWidget {
  const QuizCPUScreen({Key? key}) : super(key: key);

  @override
  QuizCPUScreenState createState() => QuizCPUScreenState();
}

class QuizCPUScreenState extends State<QuizCPUScreen> {
  var db = DBconnect();
  ...
  Future<List<Question>> getData() async {
    List<Question> questions = await db.fetchQuestions("https://arpha-d4a14-default-rtdb.firebaseio.com/cpu.json");
    questions.shuffle();
