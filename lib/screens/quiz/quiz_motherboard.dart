...
class QuizMotherboardScreen extends StatefulWidget {
  const QuizMotherboardScreen({Key? key}) : super(key: key);

  @override
  QuizMotherboardScreenState createState() => QuizMotherboardScreenState();
}

class QuizMotherboardScreenState extends State<QuizMotherboardScreen> {
  var db = DBconnect();
  ...
  Future<List<Question>> getData() async {
    List<Question> questions = await db.fetchQuestions("https://arpha-d4a14-default-rtdb.firebaseio.com/motherboard.json");
    questions.shuffle();
