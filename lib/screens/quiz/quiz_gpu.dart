...
class QuizGPUScreen extends StatefulWidget {
  const QuizGPUScreen({Key? key}) : super(key: key);

  @override
  QuizGPUScreenState createState() => QuizGPUScreenState();
}

class QuizGPUScreenState extends State<QuizGPUScreen> {
  var db = DBconnect();
  ...
  Future<List<Question>> getData() async {
    List<Question> questions = await db.fetchQuestions("https://arpha-d4a14-default-rtdb.firebaseio.com/gpu.json");
    questions.shuffle();
