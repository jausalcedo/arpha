...
class QuizPSUScreen extends StatefulWidget {
  const QuizPSUScreen({Key? key}) : super(key: key);

  @override
  QuizPSUScreenState createState() => QuizPSUScreenState();
}

class QuizPSUScreenState extends State<QuizPSUScreen> {
  var db = DBconnect();
  ...
  Future<List<Question>> getData() async {
    List<Question> questions = await db.fetchQuestions("https://arpha-d4a14-default-rtdb.firebaseio.com/psu.json");
    questions.shuffle();
