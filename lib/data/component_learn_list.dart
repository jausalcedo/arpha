...
List<ComponentLearn> COMPONENT_LEARN_LIST = [
  ComponentLearn(
    ...
    imagePath: "assets/images/learn/mobo.jpg"
  ),
  ComponentLearn(
    ...
    color: Colors.green,
    imagePath: "assets/images/learn/cpu.jpg"
  ),
  ComponentLearn(
    ...
    color: Colors.purple,
    imagePath: "assets/images/learn/ram.jpg"
  ),
  ComponentLearn(
    title: "Storage",
    ...
    color: Colors.orange,
    imagePath: "assets/images/learn/storage.jpg"
  ),
  ComponentLearn(
    ...
    color: Colors.red,
    imagePath: "assets/images/learn/psu.jpg"
  ),
  ComponentLearn(
    ...
    imagePath: "assets/images/learn/gpu.jpg"
  ),
  ComponentLearn(
    title: "Fan",
    ...
    imagePath: "assets/images/learn/fan.jpg"
  ),
];